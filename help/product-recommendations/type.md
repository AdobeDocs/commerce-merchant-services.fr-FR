...
| Consulté ceci, acheté cela | Recommande les produits que les acheteurs tendent à acheter de manière disproportionnée plus souvent après avoir consulté le produit actuel. Permet de guider les acheteurs vers la découverte de produits qu’ils n’auraient pas remarqué autrement.<br/><br/>**En cas d’utilisation :**<br/>- Détails du produit<br/>- Panier<br/>- Confirmation <br/><br/>**Étiquettes proposées :**<br/>- Clients ayant consulté cet achat ultime<br/>- Clients achetés en fin de compte<br/>- Que les autres achètent après avoir consulté ce produit ? |
