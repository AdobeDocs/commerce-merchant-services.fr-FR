---
title: "Flux de passage en caisse d’un utilisateur Bolt dans Adobe Commerce"
...
>[!WARNING]
>
> La variable [!DNL In-Store Pickup] (ISPU) n’est pas pris en charge lorsque la fonction [!DNL Quick Checkout] est activée.
