...
Adobe Experience Platform fournit une suite de technologies qui, lorsqu’elles sont enrichies de données issues de votre boutique Commerce, peuvent les distribuer via l’Edge Network à d’autres produits Adobe DX afin de déverrouiller les informations sur le comportement d’achat de votre acheteur. Grâce à ces informations détaillées, vous pouvez créer une expérience d’achat plus personnalisée sur tous les canaux.

L’image suivante montre le flux de vos données Commerce de votre magasin vers d’autres produits DX d’Adobe lorsque l’extension [!DNL Data Connection] est installée et configurée.

![Flux de données vers Edge Experience Platform ](assets/commerce-edge.png)
...
## Extraction des données de l’Experience Platform vers Commerce
...
- Droits sur d’autres produits DX Adobe.
...
Le reste de ce guide vous guide tout au long de ces étapes de manière plus détaillée afin que vous puissiez vous familiariser rapidement avec les produits DX Adobe et commencer à utiliser leur puissance dans votre boutique Commerce.
...
L’extension [!DNL Data Connection] vous permet de partager [!DNL Commerce] données de back-office avec l’Experience Platform et de respecter la loi HIPAA. [En savoir plus](hipaa-readiness.md).
