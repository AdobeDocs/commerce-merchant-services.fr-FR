...
![Nouveau](../assets/new.svg) - Disponibilité générale pour [envoyer l’ordre historique](connect-data.md#send-historical-order-data) les données et le statut à l’Experience Platform.
