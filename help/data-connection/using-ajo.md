...
- You [configuré](connect-data.md) la valeur [!DNL Data Connection] extension
- You [confirm](connect-data.md#confirm-that-event-data-is-collected) que vos données d’événement Commerce arrivent à l’Experience Platform Edge
...
1. Dans le volet de navigation de droite, configurez votre événement comme suit :
   ...
   1. Sélectionner **[!UICONTROL Fields]** et dans le **[!UICONTROL Fields]** qui s’affiche, sélectionnez les champs utiles pour cet événement. Par exemple, sélectionnez tous les champs sous le **[!UICONTROL Product list items]**, **[!UICONTROL Commerce]**, **[!UICONTROL eventType]**, et **[!UICONTROL Web]**.
   1. Cliquez sur **[!UICONTROL OK]** pour enregistrer les champs sélectionnés.
   1. Cliquez dans le **[!UICONTROL Event id condition]** et créer une condition de `eventType` est égal à `commerce.checkouts` ET `personalEmail.address` est égal à l’adresse électronique que vous avez utilisée lors de la création du profil dans la section précédente.
