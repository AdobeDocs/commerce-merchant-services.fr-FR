...
- [Événements requis](events.md) pour le tableau de bord Live Search.
...
| Option | Description |
|--- |--- |
| [Performances](performance.md) | Le tableau de bord fournit des informations sur les performances de la recherche de produits. |
...
| [GraphQL](graphql.md) | Les développeurs connectés à l’administrateur de votre boutique peuvent composer et tester des requêtes avec des données de catalogue réelles. Pour en savoir plus, accédez à la section [Présentation de GraphQL](https://developer.adobe.com/commerce/services/graphql/live-search/) dans la documentation destinée aux développeurs [!DNL Live Search]. |
